...
export interface ApiArticleItemArticleItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'article-items';
    singularName: 'article-item';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::article-item.article-item'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCertificateCertificate extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kecapAsin: Schema.Attribute.Component<'certificate.kecap-asin', false>;
    kecapInggeris: Schema.Attribute.Component<
      'certificate.kecap-inggeris',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiProductKecapAsinProductKecapAsin
  ...
  info: {
    displayName: 'productKecapAsin';
    pluralName: 'product-kecap-asins';
    singularName: 'product-kecap-asin';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    itemsKecapAsin: Schema.Attribute.Component<
      'product.items-kecap-asin',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiProductKecapInggerisProductKecapInggeris
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_kecap_inggerises';
  info: {
    displayName: 'productKecapInggeris';
    pluralName: 'product-kecap-inggerises';
    singularName: 'product-kecap-inggeris';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    itemsKecapInggeris: Schema.Attribute.Component<
      'product.items-kecap-inggeris',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
